...
const TRACK_FIELDS = `videoId, title, artist, order, "artistRef": artistRef->{ "id": _id, name, "photoAsset": photo.asset->, bio, genre, origin, links[]{ label, url }, members[]{ name, role, "photoAsset": photo.asset-> } }, "albumRef": albumRef->{ "_id": _id }`;
