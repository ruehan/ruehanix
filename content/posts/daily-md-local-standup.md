---
title: Daily.md: 로컬 standup 초안 생성기를 만든 이야기
category: dev
excerpt: 데스크톱 네이티브로 동작하는 standup 초안 생성기. 로컬 git 활동을 직접 수집하고 Claude BYOK로 Markdown 초안을 만든다. Tauri + Svelte 5로 만든 이유와 dogfood 과정에서 만난 결정들.
